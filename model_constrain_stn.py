...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 31 14:17:50 2018
...
class SpatialTransformer(nn.Module):
    ...
    def stn(self, x):
        ...
        for i in range(transformer.size()[0]):
            ...
            theta[i][0][0] = transformer[i][0]/scale
            theta[i][0][1] = -transformer[i][1]/scale
            theta[i][0][2] = transformer[i][2]
            theta[i][1][0] = transformer[i][1]/scale
            theta[i][1][1] = transformer[i][0]/scale
